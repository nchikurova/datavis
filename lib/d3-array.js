...
!(function (t, n) {
    ...
    if (1 === e.length || r.length > 1) {
      ...
      return (
        r.length > 1
          ...
          : ((e = t.map(e)), o.sort((t, r) => n(e[t], e[r]))),
        T(t, o)
      );
    }
    return t.sort(e);
  ...
  function L(t, n, r) {
    var e = (n - t) / Math.max(0, r),
      ...
      f = e / Math.pow(10, o);
    return o >= 0
      ? (f >= q ? 10 : f >= F ? 5 : f >= I ? 2 : 1) * Math.pow(10, o)
      : -Math.pow(10, -o) / (f >= q ? 10 : f >= F ? 5 : f >= I ? 2 : 1);
  }
  function P(t, n, r) {
    let e;
    for (;;) {
  ...
  function C() {
    ...
    function e(e) {
      ...
      if (!Array.isArray(h)) {
        ...
        if (
          (n === p && ([c, a] = P(c, a, r)),
          (h = O(c, a, r))[h.length - 1] >= a)
        )
          if (t >= a && n === p) {
            const t = L(c, a, r);
            isFinite(t) &&
              (t > 0
                ? (a = (Math.floor(a / t) + 1) * t)
                : t < 0 && (a = (Math.ceil(a * -t) + 1) / -t));
          } else h.pop();
      }
      ...
      var y,
        v = new Array(d + 1);
      for (o = 0; o <= d; ++o)
        ((y = v[o] = []).x0 = o > 0 ? h[o - 1] : c), (y.x1 = o < d ? h[o] : a);
      for (o = 0; o < u; ++o)
        c <= (i = l[o]) && i <= a && v[f(h, i, 0, d)].push(e[o]);
      return v;
    }
    return (
      (e.value = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : N(n)), e)
          : t;
      }),
      (e.domain = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : N([t[0], t[1]])), e)
          : n;
      }),
  ...
  function U(t, r, e = 0, o = t.length - 1, f = n) {
    for (; o > e; ) {
      if (o - e > 600) {
        const n = o - e + 1,
          i = r - e + 1,
          ...
          s = 0.5 * Math.sqrt((u * l * (n - l)) / n) * (i - n / 2 < 0 ? -1 : 1);
        U(
          t,
          r,
          Math.max(e, Math.floor(r - (i * l) / n + s)),
          Math.min(o, Math.floor(r + ((n - i) * l) / n + s)),
          f
        );
      }
      const n = t[r];
  ...
  function X(t) {
    ...
    for (var n = -1, r = R(t, Y), e = new Array(r); ++n < r; )
  ...
  (t.Adder = y),
    ...
    (t.groupSort = function (t, r, e) {
      return (
        1 === r.length
          ? j(S(t, r, e), ([t, r], [e, o]) => n(r, o) || n(t, e))
          : j(x(t, e), ([t, e], [o, f]) => r(e, f) || n(t, o))
      ).map(([t]) => t);
    }),
